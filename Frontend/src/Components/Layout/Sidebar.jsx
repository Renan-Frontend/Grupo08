    ...
    <aside className={styles.sidebar}>
      <div className={styles.sidebarContent}>
        ...
        <div className={styles.sidebarSection}>
          ...
          <ul className={styles.menuList}>
            <li
              className={`${styles.menuItem} ${isPrefixActive("/gerar-bpmn")}`}
            >
              <div
                className={styles.menuItemContent}
            ...
            <li
              className={`${styles.menuItem} ${isPrefixActive("/cadastros")}`}
            >
              <div
                className={styles.menuItemContent}
        ...
        <div className={styles.sidebarSection}>
          ...
          <ul className={styles.menuList}>
            <li
              className={`${styles.menuItem} ${isPrefixActive("/dashboard")}`}
            >
              <div
                className={styles.menuItemContent}
